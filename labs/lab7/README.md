...
В качестве клиентского устройства, подключенного двумя линками с разных коммутаторов Leaf, используем обычный коммутатор аналогичной модели. Для его подключения добавим на схему два новый коммутатора Leaf: dc1-pod1-lf4 и dc1-pod1-lf5.
